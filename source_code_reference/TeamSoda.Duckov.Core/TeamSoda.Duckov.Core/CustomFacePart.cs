...
public class CustomFacePart : MonoBehaviour
{
	...
	public void SetInfo(CustomFacePartInfo info, CustomFaceInstance _parent)
	{
		...
		Quaternion quaternion = Quaternion.Euler(0f, -info.leftRightAngle, 0f);
		Quaternion quaternion2 = Quaternion.Euler(0f, -info.leftRightAngle - info.distanceAngle, 0f);
		Quaternion quaternion3 = Quaternion.Euler(0f, -info.leftRightAngle + info.distanceAngle, 0f);
