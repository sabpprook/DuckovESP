...
{
	// Token: 0x06000A1C RID: 2588 RVA: 0x0002B5A4 File Offset: 0x000297A4
	private void OnValidate()
	{
		...
		Vector2 vector2 = new Vector2((float)(num2 % this.columns) * vector.x, 1f - vector.y - (float)(num2 / this.columns) * vector.y);
		this.projector.uvScale = vector;
		this.projector.uvBias = vector2;
	}
