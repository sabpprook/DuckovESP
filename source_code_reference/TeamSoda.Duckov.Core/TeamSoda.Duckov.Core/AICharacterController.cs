...
public class AICharacterController : MonoBehaviour
{
	...
	public void Init(CharacterMainControl _characterMainControl, Vector3 patrolCenter, AudioManager.VoiceType voiceType = AudioManager.VoiceType.Duck, AudioManager.FootStepMaterialType footStepMatType = AudioManager.FootStepMaterialType.organic)
	{
		...
		{
			this.skillInstance = global::UnityEngine.Object.Instantiate<SkillBase>(this.skillPfb, base.transform);
	...
	public ItemSetting_Skill GetItemSkill(bool random)
	{
		...
		{
			int num = global::UnityEngine.Random.Range(0, this.skillsOnItem.Count);
			ItemSetting_Skill itemSetting_Skill = this.skillsOnItem[num];
		...
		{
			int num2 = 0;
			if (num2 < this.skillsOnItem.Count)
			{
				ItemSetting_Skill itemSetting_Skill2 = this.skillsOnItem[num2];
				if (itemSetting_Skill2 == null || itemSetting_Skill2.Item == null)
				{
					this.skillsOnItem.RemoveAt(num2);
					num2--;
				}
