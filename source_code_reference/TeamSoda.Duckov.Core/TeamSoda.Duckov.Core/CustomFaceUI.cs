...
public class CustomFaceUI : MonoBehaviour
{
	...
	public void SaveToMainCharacter()
	{
		...
		CustomFaceSettingData customFaceSettingData = this.faceInstance.ConvertToSaveData();
		LevelManager.Instance.CustomFaceManager.SaveSettingToMainCharacter(customFaceSettingData);
	}
	...
	public void OnDrag(PointerEventData eventData)
	{
		...
		float num = -eventData.delta.x * this.rotateSpeed * Time.deltaTime;
		this.faceInstance.transform.Rotate(Vector3.up, num);
	}
