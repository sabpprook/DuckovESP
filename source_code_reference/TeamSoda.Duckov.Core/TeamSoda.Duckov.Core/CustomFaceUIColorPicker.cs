	...
	public void Init(CustomFaceUI _master, string titleKey)
	{
		...
		if (!this.created)
		{
			foreach (Color color in this.colors)
			{
				...
				CustomFaceUIColorPickerButton customFaceUIColorPickerButton = global::UnityEngine.Object.Instantiate<CustomFaceUIColorPickerButton>(this.singleButton, this.buttonParent);
