...
public class CustomFacePartCollection
{
	...
	{
		CustomFacePartMeta customFacePartMeta = default(CustomFacePartMeta);
		customFacePartMeta.part = newPart;
		customFacePartMeta.id = newPart.id;
		this.parts.Add(customFacePartMeta);
	}
