...
namespace ItemStatsSystem
{
	...
	public class Inventory : MonoBehaviour, ISelfValidator, IEnumerable<Item>, IEnumerable
	{
		...
		// (get) Token: 0x060000B8 RID: 184 RVA: 0x00003FC0 File Offset: 0x000021C0
		// (set) Token: 0x060000B9 RID: 185 RVA: 0x00003FC8 File Offset: 0x000021C8
		public bool Loading
		{
			get
			{
		...
		// (get) Token: 0x060000BA RID: 186 RVA: 0x00003FD1 File Offset: 0x000021D1
		// (set) Token: 0x060000BB RID: 187 RVA: 0x00003FEC File Offset: 0x000021EC
		...
		// (get) Token: 0x060000BC RID: 188 RVA: 0x00003FF5 File Offset: 0x000021F5
		...
		// (get) Token: 0x060000BD RID: 189 RVA: 0x00004002 File Offset: 0x00002202
		...
		// (get) Token: 0x060000BE RID: 190 RVA: 0x0000400A File Offset: 0x0000220A
		// (set) Token: 0x060000BF RID: 191 RVA: 0x00004012 File Offset: 0x00002212
		...
		// (get) Token: 0x060000C1 RID: 193 RVA: 0x00004024 File Offset: 0x00002224
		// (set) Token: 0x060000C0 RID: 192 RVA: 0x0000401B File Offset: 0x0000221B
		...
		// (get) Token: 0x060000C2 RID: 194 RVA: 0x0000402C File Offset: 0x0000222C
		public int Capacity
		{
			get
			{
		...
		// (get) Token: 0x060000C3 RID: 195 RVA: 0x00004034 File Offset: 0x00002234
		// (set) Token: 0x060000C4 RID: 196 RVA: 0x0000403C File Offset: 0x0000223C
		...
		// (add) Token: 0x060000C6 RID: 198 RVA: 0x00004050 File Offset: 0x00002250
		// (remove) Token: 0x060000C7 RID: 199 RVA: 0x00004088 File Offset: 0x00002288
		public event Action<Inventory, int> onContentChanged;

		// Token: 0x14000005 RID: 5
		// (add) Token: 0x060000C8 RID: 200 RVA: 0x000040C0 File Offset: 0x000022C0
		// (remove) Token: 0x060000C9 RID: 201 RVA: 0x000040F8 File Offset: 0x000022F8
		public event Action<Inventory> onInventorySorted;

		// Token: 0x14000006 RID: 6
		// (add) Token: 0x060000CA RID: 202 RVA: 0x00004130 File Offset: 0x00002330
		// (remove) Token: 0x060000CB RID: 203 RVA: 0x00004168 File Offset: 0x00002368
		public event Action<Inventory> onCapacityChanged;

		// Token: 0x14000007 RID: 7
		// (add) Token: 0x060000CC RID: 204 RVA: 0x000041A0 File Offset: 0x000023A0
		// (remove) Token: 0x060000CD RID: 205 RVA: 0x000041D8 File Offset: 0x000023D8
		public event Action<Inventory, int> onSetIndexLock;

		// Token: 0x060000CE RID: 206 RVA: 0x0000420D File Offset: 0x0000240D
		...
		// Token: 0x060000CF RID: 207 RVA: 0x0000423C File Offset: 0x0000243C
		...
		// Token: 0x060000D0 RID: 208 RVA: 0x00004285 File Offset: 0x00002485
		public bool IsIndexLocked(int index)
		{
			return this.lockedIndexes.Contains(index);
		}

		// Token: 0x060000D1 RID: 209 RVA: 0x00004293 File Offset: 0x00002493
		...
		// (get) Token: 0x060000D2 RID: 210 RVA: 0x000042AD File Offset: 0x000024AD
		...
		// Token: 0x060000D3 RID: 211 RVA: 0x000042D0 File Offset: 0x000024D0
		private void Start()
		{
		...
		// Token: 0x060000D4 RID: 212 RVA: 0x00004330 File Offset: 0x00002530
		public bool IsEmpty()
		{
		...
		// Token: 0x060000D6 RID: 214 RVA: 0x0000439C File Offset: 0x0000259C
		[ContextMenu("Sort")]
		public void Sort()
		{
			if (this.Loading)
			...
			using (List<IGrouping<Tag, Item>>.Enumerator enumerator = list2.GetEnumerator())
			{
				while (enumerator.MoveNext())
				{
					...
					{
						List<Item> list5;
						if (grouping.First<Item>().Stackable && Inventory.TryMerge(grouping, out list5))
						{
		...
		// Token: 0x060000D7 RID: 215 RVA: 0x000045D0 File Offset: 0x000027D0
		...
		// Token: 0x060000D8 RID: 216 RVA: 0x00004750 File Offset: 0x00002950
		...
		// Token: 0x060000D9 RID: 217 RVA: 0x000047E4 File Offset: 0x000029E4
		...
		public bool AddAt(Item item, int atPosition)
		{
			...
			if (item.ParentObject != null)
			{
				...
				Debug.Log(string.Format(text, array));
			...
			if (itemAt != null)
			{
				Debug.LogError(string.Format("正在尝试将物品 {0} 放入 Inventory {1} 的 {2} 位置。但此位置已经存在另一物体 {3}。", new object[] { item.DisplayName, base.name, atPosition, itemAt.DisplayName }));
			}
		...
		// Token: 0x060000DB RID: 219 RVA: 0x000049C4 File Offset: 0x00002BC4
		...
		// Token: 0x060000DC RID: 220 RVA: 0x00004A90 File Offset: 0x00002C90
		...
		// Token: 0x060000DD RID: 221 RVA: 0x00004AD0 File Offset: 0x00002CD0
		public bool RemoveItem(Item item)
		{
			int num = this.content.IndexOf(item);
			if (num < 0)
			{
				Debug.LogError(string.Concat(new string[] { "正在尝试从Inventory ", base.name, " 中删除 ", item.DisplayName, "，但它并不在这个Inventory中。" }));
				return false;
			}
			Item item2;
		...
		// Token: 0x060000DE RID: 222 RVA: 0x00004B34 File Offset: 0x00002D34
		...
		// Token: 0x060000DF RID: 223 RVA: 0x00004B80 File Offset: 0x00002D80
		...
		// Token: 0x060000E0 RID: 224 RVA: 0x00004C88 File Offset: 0x00002E88
		...
		// Token: 0x060000E1 RID: 225 RVA: 0x00004C97 File Offset: 0x00002E97
		IEnumerator IEnumerable.GetEnumerator()
		{
			return this.GetEnumerator();
		}

		// Token: 0x060000E2 RID: 226 RVA: 0x00004CA0 File Offset: 0x00002EA0
		...
		// Token: 0x060000E3 RID: 227 RVA: 0x00004CE7 File Offset: 0x00002EE7
		public List<Item> FindAll(Predicate<Item> match)
		{
			return this.content.FindAll(match);
		}

		// Token: 0x060000E4 RID: 228 RVA: 0x00004CF8 File Offset: 0x00002EF8
		...
		// Token: 0x060000E7 RID: 231 RVA: 0x00004DE4 File Offset: 0x00002FE4
		...
		// Token: 0x060000E8 RID: 232 RVA: 0x00004E0C File Offset: 0x0000300C
		...
		// Token: 0x060000E9 RID: 233 RVA: 0x00004E28 File Offset: 0x00003028
		public Item Find(int typeID)
		{
			return this.content.Find((Item e) => e != null && e.TypeID == typeID);
		}

		// Token: 0x060000EB RID: 235 RVA: 0x00004E8A File Offset: 0x0000308A
		[CompilerGenerated]
