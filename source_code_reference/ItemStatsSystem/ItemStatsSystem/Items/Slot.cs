...
namespace ItemStatsSystem.Items
{
	...
	public class Slot
	{
		...
		// (get) Token: 0x0600020D RID: 525 RVA: 0x000081A8 File Offset: 0x000063A8
		public Item Master
		{
			get
			{
		...
		// (get) Token: 0x0600020E RID: 526 RVA: 0x000081BB File Offset: 0x000063BB
		public Item Content
		{
			get
			{
		...
		// (get) Token: 0x0600020F RID: 527 RVA: 0x000081C3 File Offset: 0x000063C3
		...
		// (get) Token: 0x06000210 RID: 528 RVA: 0x000081CA File Offset: 0x000063CA
		// (set) Token: 0x06000211 RID: 529 RVA: 0x000081D2 File Offset: 0x000063D2
		...
		// (get) Token: 0x06000212 RID: 530 RVA: 0x000081DB File Offset: 0x000063DB
		...
		// (get) Token: 0x06000213 RID: 531 RVA: 0x000081E3 File Offset: 0x000063E3
		public string Key
		{
			get
			{
		...
		// (get) Token: 0x06000214 RID: 532 RVA: 0x000081EC File Offset: 0x000063EC
		...
		// (add) Token: 0x06000215 RID: 533 RVA: 0x00008238 File Offset: 0x00006438
		// (remove) Token: 0x06000216 RID: 534 RVA: 0x00008270 File Offset: 0x00006470
		public event Action<Slot> onSlotContentChanged;

		// Token: 0x06000217 RID: 535 RVA: 0x000082A5 File Offset: 0x000064A5
		public void Initialize(SlotCollection collection)
		{
			this.collection = collection;
		}

		// Token: 0x06000218 RID: 536 RVA: 0x000082AE File Offset: 0x000064AE
		...
		// Token: 0x06000219 RID: 537 RVA: 0x000082C4 File Offset: 0x000064C4
		...
		// Token: 0x0600021A RID: 538 RVA: 0x000083CC File Offset: 0x000065CC
		...
		// Token: 0x0600021B RID: 539 RVA: 0x000084B4 File Offset: 0x000066B4
		public Item Unplug()
		{
		...
		// Token: 0x0600021C RID: 540 RVA: 0x00008523 File Offset: 0x00006723
		public bool CanPlug(Item item)
		{
			return !(item == null) && this.CheckAbleToPlug(item);
		}

		// Token: 0x0600021D RID: 541 RVA: 0x00008537 File Offset: 0x00006737
		public Slot()
		{
		}

		// Token: 0x0600021E RID: 542 RVA: 0x00008555 File Offset: 0x00006755
