...
namespace ItemStatsSystem.Stats
{
	...
	public class Modifier
	{
		...
		// (get) Token: 0x06000202 RID: 514 RVA: 0x00007FB2 File Offset: 0x000061B2
		public int Order
		{
			get
			{
		...
		// (get) Token: 0x06000203 RID: 515 RVA: 0x00007FC9 File Offset: 0x000061C9
		...
		// (get) Token: 0x06000204 RID: 516 RVA: 0x00007FD1 File Offset: 0x000061D1
		// (set) Token: 0x06000205 RID: 517 RVA: 0x00007FD9 File Offset: 0x000061D9
		public float Value
		{
			get
			{
		...
		// (get) Token: 0x06000206 RID: 518 RVA: 0x00007FFE File Offset: 0x000061FE
		...
		// Token: 0x06000207 RID: 519 RVA: 0x00008006 File Offset: 0x00006206
		public Modifier(ModifierType type, float value, object source)
			: this(type, value, false, 0, source)
		{
		}

		// Token: 0x06000208 RID: 520 RVA: 0x00008013 File Offset: 0x00006213
		...
		// Token: 0x06000209 RID: 521 RVA: 0x00008040 File Offset: 0x00006240
		...
		// Token: 0x0600020A RID: 522 RVA: 0x00008071 File Offset: 0x00006271
		...
		// Token: 0x0600020B RID: 523 RVA: 0x00008090 File Offset: 0x00006290
		public override string ToString()
		{
			...
			text = string.Concat(new string[] { "<color=", text2, ">", text, "</color>" });
