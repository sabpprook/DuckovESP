...
namespace Duckov.Utilities
{
	...
	public static class RandomUtilities
	{
		...
		public static void RandomizeOrder<T>(this List<T> list)
		{
			...
			{
				int num = global::UnityEngine.Random.Range(i, count - 1);
				T t = list[num];
				list.RemoveAt(num);
				list.Insert(i, t);
			}
		...
		public static T GetRandom<T>(this IList<T> list, global::System.Random rng)
		{
			if (list.Count < 1)
			{
				return default(T);
		...
		public static T GetRandomWeighted<T>(this IList<T> list, Func<T, float> weightFunction, float lowPercent = 0f)
		{
			...
			float num2 = 0f;
			float num3 = global::UnityEngine.Random.Range(num * lowPercent, num);
